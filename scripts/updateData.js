...
async function main() {
  ...
  try {
    ...
    // ── SK Margin ──────────────────────────────────────────────────────────────
    // Nákupní ceny pro SK nejsou k dispozici → prázdný soubor
    writeMarginTsFile(path.join(DATA_DIR, 'marginDataSK.ts'), 'marginDataSK', 'EUR', []);
    log('SK margin: nákupní ceny nejsou k dispozici');
