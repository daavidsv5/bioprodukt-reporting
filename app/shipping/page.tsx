...
import { Truck, CreditCard, DollarSign, Banknote, Gift, Save, RotateCcw } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
          ...
          <KpiCard title="Doprava zdarma %"    value={formatPercent(freeShippingPct)}                yoy={yoyPct(freeShippingPct, prevFreeShippingPct)}   icon={<Gift size={16} />}       sparklineData={[]}            hasPrevData={hasPrevData} />
        </div>
      </div>
