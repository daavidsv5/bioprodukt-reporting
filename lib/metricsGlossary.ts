...
export const VALUE_LABEL = "Bioprodukt JT";

export const VALUE_SCOPE = "CZ + SK přepočtené do Kč.";

export const SEGMENT_LABEL = "zdravých ovocných svačin a snacků";

export const SEGMENT_DESCRIPTION =
  "Bioprodukt JT prodává zdravé ovocné snacky, hlavně jablečné trubičky a kuličky s polevou, dětské svačiny a sezónní edice (CZ, SK). Jde o levnější spotřební zboží pro rodiny s dětmi, které se kupuje opakovaně, často ve větších baleních. Klíčová je cena akvizice prvního nákupu a to, jak rychle se zákazník vrátí.";
...
export const METRICS: MetricDefinition[] = [
  {
    ...
    benchmark: { text: "Absolutní hodnota nemá tržní benchmark, sledujte meziroční vývoj (YoY) a sezónnost (začátek školního roku, Vánoce)." },
  ...
  },
  {
    ...
    benchmark: { text: "Zdravé snacky a dětské svačiny mají AOV orientačně 500 až 900 Kč s DPH. Zvyšují ho velká balení (43 ks) a sady příchutí.", min: 500, max: 900, better: "higher" },
  ...
  },
  {
    ...
    where: ["Hlavní KPI", "Analýza marže"],
    benchmark: { text: "Absolutní hodnota bez benchmarku, sledujte YoY a poměr k marketingovým investicím (POAS)." },
    note: "CZ nemá v datech nákupní ceny před 12/2024. Za starší období vychází marže 100 % a je nadhodnocená.",
  ...
  },
  {
    ...
    where: ["Roční přehled", "Měsíční přehled", "Hlavní KPI", "Analýza marže"],
    benchmark: { text: "Potravinové snacky orientačně 35 až 50 %. Plošné slevy (například 10 % na vše) marži citelně snižují.", min: 35, max: 50, better: "higher" },
  ...
  },
  {
    ...
    where: ["Hlavní KPI", "Analýza marže"],
    benchmark: { text: "Orientačně 15 až 25 % je zdravé pásmo pro potravinový e-shop. Pod 10 % marketing „sní“ většinu marže.", min: 15, max: 25, better: "higher" },
  ...
  },
  {
    ...
    where: ["Hlavní KPI"],
    benchmark: { text: "Mělo by pokrýt vychystání a dopravu jedné objednávky (orientačně 70 až 130 Kč) s rezervou." },
  ...
  },
  {
    ...
    formula: "Σ náklady Google Ads + Meta (Facebook/Instagram) + Sklik + Heureka",
  ...
  },
  {
    ...
    where: ["Roční přehled", "Měsíční přehled", "Hlavní KPI", "Marketingový Mix & PNO"],
    benchmark: { text: "Potravinové snacky orientačně 15 až 22 %. Interní cílové PNO z auditu (9/2026) je 22 % z tržeb bez DPH. Tvrdá hranice je, že PNO musí být nižší než Marže %.", min: 15, max: 22, better: "lower" },
  ...
  },
  {
    ...
    formula: "Marže / Marketingové investice",
    where: ["Hlavní KPI"],
    benchmark: { text: "Pod 1,0× marketing prodělává marži · 1 až 2× akviziční fáze · 2 až 3× zdravý stav · nad 3× prostor přidat rozpočet.", min: 2, max: 3, better: "higher" },
  ...
  },
  {
    ...
    benchmark: { text: "Potraviny v CZ orientačně Google Ads 3 až 8 Kč, Sklik 2 až 6 Kč, Heureka 2 až 5 Kč, Meta 3 až 8 Kč." },
  },
  {
    id: "cac",
  ...
  },
  {
    ...
    where: ["Hlavní KPI"],
    benchmark: { text: "U opakovaně kupovaných svačin by LTV mělo být orientačně 1,8 až 3násobek AOV bez DPH." },
  ...
  },
  {
    ...
    category: "zakaznici",
    meaning: "Podíl zákazníků, kteří nakoupili alespoň dvakrát. U svačin a snacků pro děti je to hlavní páka dlouhodobé ziskovosti.",
    formula: "Zákazníci s 2+ objednávkami / Všichni zákazníci × 100",
    where: ["Retenční analýza"],
    benchmark: { text: "Spotřební potraviny a dětské svačiny orientačně 25 až 40 %.", min: 25, max: 40, better: "higher" },
  ...
  },
  {
    ...
    where: ["Retenční analýza"],
    benchmark: { text: "Spotřeba balení svačin orientačně 45 až 90 dní.", min: 45, max: 90, better: "lower" },
  ...
  },
  {
    ...
    where: ["Roční přehled", "Měsíční přehled", "Webová návštěvnost (GA4)"],
    benchmark: { text: "Potraviny a snacky orientačně 2 až 4 %. Mobil bývá výrazně níž než desktop, typicky na přechodu z košíku do pokladny." },
  },
  {
    id: "bounce",
    name: "Bounce rate",
  ...
  },
  {
    ...
    note: "Audit 9/2026 ukázal jako nejslabší krok zahájení objednávky na doprava a platba (hlavně SK a mobil).",
  },
  {
    id: "meta-ctr",
    name: "CTR (Meta)",
    ...
    where: ["Meta Ads"],
    benchmark: { text: "Potraviny a dětské produkty na Metě orientačně 1 až 2 %. Pod 0,8 % obvykle unavená kreativa nebo příliš vysoká frekvence." },
  },
  {
    id: "meta-cpc",
    name: "CPC (Meta)",
    ...
    where: ["Meta Ads"],
    benchmark: { text: "CZ/SK potraviny orientačně 3 až 8 Kč (0,12 až 0,32 €)." },
  },
  {
    id: "meta-cpa",
    name: "CPA (Meta)",
  ...
  },
  {
    ...
    where: ["Meta Ads"],
    benchmark: { text: "Potravinové e-shopy orientačně 3 až 5× (podle Mety). Atribuce Mety bývá nadsazená, ověřujte proti PNO a POAS z e-shopu." },
  },
  {
    id: "abc",
    ...
    benchmark: { text: "Úzký sortiment snacků často stojí na 2 až 3 produktech (typicky 50 % tržeb). Hlídejte jejich dostupnost a sklad." },
  },
  {
    id: "doprava-zdarma",
    name: "Doprava zdarma %",
    ...
    benchmark: { text: "Orientačně 20 až 40 %. Hranice dopravy zdarma by měla být těsně nad běžnou hodnotou košíku." },
  },
  {
    id: "doprava-zisk",
