...
export const SEGMENT_DESCRIPTION =
  "Bioprodukt JT prodává zdravé ovocné snacky: jablečné trubičky a kuličky s polevou, dětské svačiny a sezónní edice (CZ, SK). Jde o levnější spotřební zboží pro rodiny s dětmi, které se kupuje opakovaně, často ve větších baleních. Klíčová je cena akvizice prvního nákupu a to, jak rychle se zákazník vrátí.";
...
export const METRICS: MetricDefinition[] = [
  ...
  },
  {
    ...
    where: ["Hlavní Dashboard", "Hlavní KPI", "Analýza marže"],
  ...
  },
  {
    ...
    where: ["Hlavní Dashboard", "Hlavní KPI", "Marketingový Mix & PNO"],
    benchmark: { text: "Potravinové snacky orientačně 15 až 22 %. Interní cílové PNO z auditu (9/2026) je 22 % z tržeb bez DPH. Tvrdá hranice: PNO musí být nižší než Marže %.", min: 15, max: 22, better: "lower" },
